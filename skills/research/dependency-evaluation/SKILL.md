...
Dependency evaluation: CVE reachability, license risk, maintenance, supply chain. Audit before adding/updating.
...
- source-2 owasp-secure-agent-playbook/plugins/code-security-skills/skills/sca-audit in references/source-2-verbatim/
...
--- BEGIN VERBATIM SOURCE 2: owasp-secure-agent-playbook/plugins/code-security-skills/skills/sca-audit ---
