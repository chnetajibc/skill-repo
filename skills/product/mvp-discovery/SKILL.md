...
3. Specify: user stories with acceptance criteria, UX flow, data needs, success metric (see `references/upstream-product-discovery/`, `references/upstream-product-shaping/`).
...
- `references/upstream-product-discovery/`, `references/upstream-product-shaping/`.
