...
Design for high cohesion low coupling, stable interfaces, localized change. Architecture emerges from requirements, not ceremony.
...
SOURCE: magnus919-agent-skills/software-architecture
