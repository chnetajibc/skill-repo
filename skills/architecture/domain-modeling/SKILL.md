...
Model entities, value objects, aggregates, ownership, invariants. Separate domain, persistence, DTO, response models; never auto-expose ORM entities.

## Sources fused without loss (verbatim)

- source-1 bjornjee-skills/skills/data-modeling in references/source-1-verbatim/
- source-2 magnus919-agent-skills/data-architect in references/source-2-verbatim/
- Both bodies inlined below in full. Stricter wins on overlap; if conflict prefer safer/security-first and note assumption.

--- BEGIN VERBATIM SOURCE 1: bjornjee-skills/skills/data-modeling ---
...
--- BEGIN VERBATIM SOURCE 2: magnus919-agent-skills/data-architect ---
