---
name: containers
description: "Containers: minimal images, non-root, pinned digests, secret hygiene, compose security. See checklists/examples in verbatim refs."
---

# containers

Containers: minimal images, non-root, pinned digests, secret hygiene, compose security. See checklists/examples in verbatim refs.
...
SOURCE: rubencr14-agent-skills/skills/cybersecurity
